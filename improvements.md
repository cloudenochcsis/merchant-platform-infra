...
- **Controlled CI/CD:** run formatting, validation, `terraform test`, security/policy checks, and reviewed plans before a separately approved apply; publish immutable application images and support automated rollback.
